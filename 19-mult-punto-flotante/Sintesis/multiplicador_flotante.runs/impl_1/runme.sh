...
HD_PWD='C:/pd/2024-CLP/01_guia_vhdl/19-mult-punto-flotante/Sintesis/multiplicador_flotante.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_flot_vio.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mult_flot_vio.tcl -notrace
