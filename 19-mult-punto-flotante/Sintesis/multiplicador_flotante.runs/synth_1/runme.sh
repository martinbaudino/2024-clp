...
HD_PWD='C:/pd/2024-CLP/01_guia_vhdl/19-mult-punto-flotante/Sintesis/multiplicador_flotante.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_flot_vio.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_flot_vio.tcl
