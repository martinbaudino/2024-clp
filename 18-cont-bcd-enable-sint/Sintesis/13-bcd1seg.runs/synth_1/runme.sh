...
HD_PWD='C:/pd/2024-CLP/01_guia_vhdl/18-cont-bcd-enable-sint/Sintesis/13-bcd1seg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log contBCD_VIO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source contBCD_VIO.tcl
