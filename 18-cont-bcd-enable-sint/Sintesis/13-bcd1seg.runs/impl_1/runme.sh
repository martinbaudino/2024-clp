...
HD_PWD='C:/pd/2024-CLP/01_guia_vhdl/18-cont-bcd-enable-sint/Sintesis/13-bcd1seg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log contBCD_VIO.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source contBCD_VIO.tcl -notrace
